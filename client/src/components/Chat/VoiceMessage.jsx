...
const VoiceMessage = ({message}) => {
  ...
  useEffect(() => {
    if (audioMessage) {
      ...
      audioMessage.addEventListener("timeupdate", upadatePlaybackTime);

      return () => {
        audioMessage.removeEventListener("timeupdate", upadatePlaybackTime);
      };
    }
  }, [audioMessage]);
  ...
  return (
    <div
      className={`flex  items-center gap-5 text-white p-4 text-sm rounded-md ${
